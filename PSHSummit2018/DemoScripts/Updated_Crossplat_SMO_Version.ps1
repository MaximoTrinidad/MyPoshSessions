...
sqlcmd -S sapien01,1451 -U SA -P '$SqlPwd01!'
...
### - Help find and save the location of the SMO dll's in a PowerShell variable: ver.14.17199
#$smopath = Join-Path ((Get-Package Microsoft.SqlServer.SqlManagementObjects).Source `
#	| Split-Path) (Join-Path lib netcoreapp2.0)

### - To be release soon - In Windows Test Only ##
